...
public class SyncTokenSample {
    ...
    static void run() throws IOException {
        calendarService = GoogleServices.getCalendarService();

        eventDataStore = GoogleServices.getDataStoreFactory().getDataStore("EventStore");
        syncSettingsDataStore = GoogleServices.getDataStoreFactory().getDataStore("SyncSettings");
        ...
        if (syncToken == null) {
            ...
            Date oneYearAgo = GoogleServices.getRelativeDate(java.util.Calendar.YEAR, -1);
